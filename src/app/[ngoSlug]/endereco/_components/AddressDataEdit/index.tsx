...
export const AddressDataEdit: FunctionComponent<AddressDataEditProps> = ({slug}) => (
    <ProtectStep
        slug={slug}
        requiredInfo="user"
        render={(
            <Fragment>
                <h2 className="mb-3 text-center font-semibold text-lg text-gray-800 leading-7">Endereço</h2>
