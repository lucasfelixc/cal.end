...
import { PaymentWay } from "@/hooks/useScheduleInfo";
import { CreditCard, Barcode, Landmark } from "lucide-react";
...
export const PaymentWayCard: FunctionComponent<PaymentWayCardProps> = (
    props
) => {
