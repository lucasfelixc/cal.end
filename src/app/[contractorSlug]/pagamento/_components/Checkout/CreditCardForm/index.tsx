...
export const CreditCardForm: FunctionComponent<CreditCardFormProps> = ({
    ...
    const { creditCard } = scheduleInfo?.paymentMethodInfo ?? {};
    const form = useForm<TFormSchema>({
        ...
        defaultValues: {
            ...
            cvc: creditCard?.cvc,
            expirationDate:
                (creditCard?.exp_month ?? null) !== null &&
                (creditCard?.exp_year ?? null) !== null
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    ...
                                    onChange={(value) =>
                                        field.onChange(
                                            creditCardMask(value.target.value)
                                        )
                                    }
                                />
                            </FormControl>
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input
                                    {...field}
                                    aria-label="Nome inserido no cartão"
                                />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
