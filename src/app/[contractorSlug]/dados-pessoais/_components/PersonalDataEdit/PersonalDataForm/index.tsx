...
export const PersonalDataForm: FunctionComponent<PersonalDataFormProps> = ({
    slug,
}) => {
    const router = useRouter();
    const { scheduleInfo, setScheduleInfo } = useScheduleInfo();
    const [loading, setLoading] = useState(false);
    const { firstname, lastname, cpf, phone, email, birthday } =
        scheduleInfo?.user ?? {};
...
const formSchema = z.object({
    ...
    lastname: z
        ...
        .trim()
        .min(3, {
            message: "O tamanho mínimo do sobrenome é de 3 caracteres.",
        }),
    cpf: z
    ...
    phone: z
        ...
        .trim()
        .min(15, {
            message: "O tamanho mínimo do telefone é de 11 caracteres.",
        })
        .max(15, {
            message: "O tamanho máximo do telefone é de 11 caracteres.",
        }),
    email: z
